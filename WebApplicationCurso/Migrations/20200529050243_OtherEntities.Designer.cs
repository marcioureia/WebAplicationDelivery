...
namespace WebApplicationCurso.Migrations
{
    ...
    [Migration("20200529050243_OtherEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplicationCurso.Models.SalesRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebApplicationCurso.Models.Seller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebApplicationCurso.Models.SalesRecord", b =>
                {
                    b.HasOne("WebApplicationCurso.Models.Seller", "Seller")
                        .WithMany("Sales")
            ...
            modelBuilder.Entity("WebApplicationCurso.Models.Seller", b =>
                {
                    b.HasOne("WebApplicationCurso.Models.Department", "Department")
                        .WithMany("Sellers")
